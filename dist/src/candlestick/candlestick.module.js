...
const candlestick_controller_1 = require("./candlestick.controller");
...
exports.CandlestickModule = CandlestickModule = __decorate([
    (0, common_1.Module)({
        controllers: [candlestick_controller_1.CandlestickController],
        providers: [candlestick_service_1.CandlestickService],
    })
], CandlestickModule);
